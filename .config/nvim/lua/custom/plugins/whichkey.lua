local mappings = {
  ...
  ['<leader>l'] = {
    ...
    i = {
      ...
      o = { '<cmd>lua vim.lsp.buf.document_symbol()<cr>', 'Outline / Symbols' },
      r = { '<cmd>lua vim.lsp.buf.rename()<cr>', 'Rename' },
      d = { '<cmd>lua vim.lsp.buf.definition()<cr>', 'GoTo Definition' },
      -- This replaces Lspsaga finder; results go to quickfix + bqf
      f = { '<cmd>lua vim.lsp.buf.references()<cr>', 'LSP Finder (Quickfix)' },
      p = { '<cmd>lua vim.lsp.buf.hover()<cr>', 'Peek / Hover Doc' },
      s = { '<cmd>lua vim.lsp.buf.signature_help()<cr>', 'Signature Help' },
      w = { '<cmd>lua vim.diagnostic.setqflist()<cr>', 'Show Workspace Diagnostics' },
      K = { '<cmd>lua vim.lsp.buf.hover()<cr>', 'Display Documentation' },
    },
  },
