  ...
  config = function()
    ...
    cmp.setup {
      ...
      mapping = cmp.mapping.preset.insert {
        ...
        ['<C-p>'] = cmp.mapping(cmp.mapping.select_prev_item { behavior = types.cmp.SelectBehavior.Select }, { 'i', 'c' }),
        ['<C-n>'] = cmp.mapping(cmp.mapping.select_next_item { behavior = types.cmp.SelectBehavior.Select }, { 'i', 'c' }),
        ['<C-h>'] = function()
